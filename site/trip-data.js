  ...
  return [
    {
      ...
      flight: {
        summary: "Expected pattern — STL–LIS / OPO–STL open jaw; usually one connection each way, with two possible from Porto on weaker dates.",
        detail: "Test protected tickets through a U.S. or European gateway. London or Frankfurt are examples only if relevant STL service operates; Newark, Washington Dulles, Philadelphia, Boston, JFK, or Miami are other examples to test. Allow roughly 11–17 hours each way. If OPO is poor, position by rail to Lisbon the prior day and add the airport-area night openly.",
    ...
    },
    {
      ...
      flight: {
        ...
        detail: "Test London, Frankfurt, or a U.S. gateway as examples, not promises. Allow roughly 11–18 hours each way, excluding Seville–Madrid positioning. If MAD is the return gateway, prefer a prior airport-area night and update the hotel count and planning range.",
    ...
    },
    {
      ...
      flight: {
        summary: "Expected pattern — STL–MXP inbound with one connection; return via PUY, TRS, VCE, or ZAG remains unresolved and may require one or two connections.",
        detail: "Allow roughly 12–20 hours to MXP plus the lake transfer and 14–24 hours home including Rovinj ground travel. Seasonal Venice–Rovinj ferry service is not confirmed for 2027. Use a daytime coach or prebooked ground transfer as the dependable planning fallback; exact PUY usefulness must be checked when dates publish.",
    ...
    },
    {
      ...
      flight: {
        summary: "Expected pattern — STL–U.S. gateway–Auckland–Queenstown, usually two connections; Sydney–STL usually one or two connections.",
        detail: "Allow roughly 22–32 hours inbound and 19–27 hours home. Leaving STL on Day 1 normally consumes Day 2 and reaches Queenstown on Day 3 local time. ZQN–SYD may be direct or require a protected Auckland connection; exact 2027 service is not confirmed.",
