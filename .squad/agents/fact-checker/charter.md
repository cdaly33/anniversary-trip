...
- **Casting:** Persistent descriptive name confirmed for this squad.
...
### Anniversary-Trip Verification Priorities

- Live or future prices, availability, taxes, and booking conditions
- Flight, rail, ferry, and transfer schedules
- Seasonal openings, closures, reservation requirements, and operating days
- Entry requirements, official advisories, and safety claims
- Weather claims matched to the proposed region and month
...
Verify the three primary concepts—Northern Italy + Croatia, New Zealand + Australia, and Portugal—using current, authoritative, date-stamped sources. Treat future prices and schedules as provisional.
...
`.squad/fact-checker/policy.md` is authoritative. Append succinct evidence only to `.squad/fact-checker/audit-trail.md` and durable personal learnings only to `.squad/agents/fact-checker/history.md`. Propose shared decisions through `.squad/decisions/inbox/`; never edit another agent's history.
